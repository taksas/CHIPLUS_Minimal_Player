...
namespace CHIPLUS_Minimal_Player
{
        ...
        */
        ...
        public Form1()
        {
            ...
            async void InitializeAsync()
            {
                ...
                string strip = "Mozilla/5.0 (Linux; U; Android 2.2.1; en-us; Nexus One Build/FRG83) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1";
    ...
    */
            ...
            toolStripMenuItemhome.Text = "トップページ";
            ...
            */
            ...
            toolStripMenuItemchannel.Text = "ダッシュボード";
            ...
            toolStripMenuItemlib.Text = "カレンダー";
        ...
        */
        ...
        {
            WebView.CoreWebView2.Navigate("https://kadai-moodle.kagawa-u.ac.jp/my/");
        }

        private void ToolStripMenuItem_Clicklib(object sender, EventArgs e)
        {
            WebView.CoreWebView2.Navigate("https://kadai-moodle.kagawa-u.ac.jp/calendar/view.php?view=month");
        }
        ...
        private void ToolStripMenuItem_Clickurl(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show(msgtext1, "現在表示中のサイトURL（OKをクリックでクリップボードにコピーされます）", MessageBoxButtons.OKCancel) == System.Windows.Forms.DialogResult.OK)
        ...
        {
            string msgtext = "https://github.com/taksas/CHIPLUS_Minimal_Player";
